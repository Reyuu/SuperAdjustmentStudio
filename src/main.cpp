...
SPI_PLUGINSIDE_SUPPORT(LPLUGIN_NAME, LPLUGIN_AUTHOR, LPLUGIN_VERSION, SPI_GAME_LE1, SPI_VERSION_ANY);
#elif defined(SDK_TARGET_LE3)
SPI_PLUGINSIDE_SUPPORT(LPLUGIN_NAME, LPLUGIN_AUTHOR, LPLUGIN_VERSION, SPI_GAME_LE3, SPI_VERSION_ANY);
#else
